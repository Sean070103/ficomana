...
export const adminOverlay = 'fixed inset-0 bg-black/70 backdrop-blur-sm flex z-50'
export const adminDrawer = 'bg-[#0A0A0F] border-l border-white/10 w-full max-w-lg h-full flex flex-col shadow-2xl'
export const adminModal = 'bg-[#0A0A0F] border border-white/10 shadow-2xl overflow-hidden'
