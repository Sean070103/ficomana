...
export const PACKAGE_SEED_ROWS: PackageSeedRow[] = [
  ...
  },
  {
    ...
    price_display: '₱13,500',
    price_amount: 13500,
    duration: '2–3 hours photoshoot',
    description: 'Light Effects / Curtain / Simple Studio Setup',
    features: [
    ...
    slot_type: 'makeup',
    secondary_price_display: '₱15,500',
    secondary_price_amount: 15500,
    secondary_price_label: 'With Hair & Make Up (2 pegs)',
    book_variants: [
  ...
  },
  {
    ...
    price_display: '₱15,500',
    price_amount: 15500,
    duration: '2–3 hours photoshoot (includes HMUA for 2 pegs)',
    description: 'Light Effects / Curtain / Simple Studio Setup with Hair & Makeup',
    features: [
      '2–3 hours photoshoot',
      "2 layouts (client's peg & plain backdrop)",
      'Professional photographer',
  ...
  },
  {
    ...
    title: 'FICO 1 — Solo or Duo Digital',
    price_display: 'Php 350',
    price_amount: 350,
    duration: '10 mins studio shoot',
    description: 'Solo or Duo Digital',
    features: [
  ...
  },
  {
    id: 'fico-2',
    category: 'self-portrait',
    title: 'FICO 2 — Solo or Duo',
    price_display: 'Php 600',
    price_amount: 600,
    duration: '15 mins studio shoot',
    description: 'Solo or Duo — Best Seller',
    features: [
  ...
  },
  {
    id: 'fico-3',
    category: 'self-portrait',
    title: 'FICO 3 — Without Hair and Makeup',
    price_display: 'Php 700',
    price_amount: 700,
    duration: '15 mins studio shoot',
  ...
  },
  {
    id: 'fico-4',
    category: 'self-portrait',
    title: 'FICO 4 — With Hair and Makeup',
    price_display: 'Php 1,000',
    price_amount: 1000,
    duration: '20 mins studio shoot',
  ...
  },
  {
    id: 'mana-1',
    category: 'self-portrait',
    title: 'MANA 1 — Family / Barkada',
    price_display: 'Php 700',
    price_amount: 700,
    duration: '10 mins studio shoot',
    description: 'Family / Barkada',
    features: [
      '3–5 pax (any age)',
      '10 mins studio shoot',
      'Your choice of backdrop (1)',
  ...
  },
  {
    id: 'mana-2',
    category: 'self-portrait',
    title: 'MANA 2 — Family / Barkada',
    price_display: 'Php 1,200',
    price_amount: 1200,
    duration: '15 mins studio shoot',
    description: 'Family / Barkada',
    features: [
  ...
  },
  {
    id: 'mana-3',
    category: 'self-portrait',
    title: 'MANA 3 — Family / Barkada',
    price_display: 'Php 1,500',
    price_amount: 1500,
    duration: '20 mins studio shoot',
    description: 'Family / Barkada',
    features: [
  ...
  },
  {
    id: 'mana-4',
    category: 'self-portrait',
    title: 'MANA 4 — Family / Barkada',
    price_display: 'Php 2,000',
    price_amount: 2000,
    duration: '20 mins studio shoot',
    description: 'Family / Barkada',
    features: [
